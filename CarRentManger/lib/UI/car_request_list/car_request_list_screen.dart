import 'package:carrentmanger/UI/car_request_list/controller/car_request_list_controller.dart';
import 'package:carrentmanger/UI/car_request_list/widget/car_List_widget.dart';
...
class CarRequestListScreen extends StatelessWidget {
  const CarRequestListScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder(
      init:  CarRequestListController(),
      builder: (CarRequestListController controller) =>  SafeArea(
        child: Scaffold(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(Localizations.localeOf(context).languageCode == "en"
                          ?"There are no registered requests yet.":"لا يوجد طلبات مسجله حتى الآن",
                        style: TextStyle(
